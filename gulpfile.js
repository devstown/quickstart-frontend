...
// copy necessary fontawesome scss files 
gulp.task('fascss', function() {
	return gulp.src(['node_modules/fontawesome-web/scss/*'])
	.pipe(gulp.dest('src/assets/scss/fontawesome'))
});
...
//run
gulp.task('default', ['serve', 'fa', 'bs', 'bsscss', 'fascss', 'fonts', 'js']);
